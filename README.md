...
Custom Chains: Structured outputs (Answer + Tags) using RunnablePassthrough, ChatPromptTemplate, and StrOutputParser.
...
Prompt Engineering: Enforcing neat, human‑friendly responses with tags.

Multi‑LLM Testing: Comparing Groq, OpenAI, HuggingFace, and Gemma outputs in RAG pipelines.
